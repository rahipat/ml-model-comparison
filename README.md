...
1. Loads and analyzes the crime dataset
2. Computes feature correlations with total arrests
3. Selects the top correlated features
4. Trains and evaluates 12 machine learning models
5. Selects the best-performing model
6. Saves evaluation results and feature importance to CSV files
